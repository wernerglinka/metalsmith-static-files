...
const debug = debugModule( 'metalsmith-static-files' );
...
function plugin( options ) {
  ...
  return function metalsmithStaticFiles( files, metalsmith, done ) {
    try {
      ...
      // Copy the directory
      fs.copy( source, destination, copyOptions ).then( () => {
...
export { plugin as default, normalizeOptions };
